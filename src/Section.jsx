...
const props = {
    header: '25% off all alligators and venomous snakes!',
    paragraph: 'This is a once in a lifetime opportunity to own these beautiful creatures for a discount. With Christmas around the corner this is really a no-brainer if you have kids.'
}
...
function Section(){
    ...
    return(
        <>
            ...
            <Header header = '25% off all alligators and venomous snakes!'  />
            <Paragraph paragraph = 'This is a once in a lifetime opportunity to own these beautiful creatures for a discount. With Christmas around the corner this is really a no-brainer if you have kids.'/>
            <Button  text='Touch my button' handleButton={handleButton}/>
